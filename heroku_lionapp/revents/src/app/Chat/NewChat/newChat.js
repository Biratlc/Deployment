...
class NewChatComponent extends React.Component {
  ...
  buildDocKey = () => [firebase.auth().currentUser.email, this.state.username , this.state.timestamp].sort().join(':');
  ...
  goToChat = () => this.props.goToChatFn(this.buildDocKey(), this.state.message ,this.state.timestamp);
